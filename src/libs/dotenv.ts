const dotenv = {
  ...
  GOOGLE_SITE_VERIFICATION_ID: process.env
    .NEXT_PUBLIC_GOOGLE_SITE_VERIFICATION_ID as string,

  NAVER_SITE_VERIFICATION_ID: process.env
    .NEXT_PUBLIC_NAVER_SITE_VERIFICATION_ID as string,

  BING_SITE_VERIFICATION_ID: process.env
    .NEXT_PUBLIC_BING_SITE_VERIFICATION_ID as string,
